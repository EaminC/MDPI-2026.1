...
\texttt{\textbf{end for}}\\
\texttt{\textbf{Compute} $\hat{R} = U_k \Sigma_k V_k^T$ and \textbf{return} $\hat{R}$}\\
\rule{\columnwidth}{1pt}
\end{algorithm}
...
\texttt{\textbf{end for}}\\
\texttt{\textbf{Sort} candidates by similarity in descending order and \textbf{return} top-$N$}\\
\rule{\columnwidth}{1pt}
\end{algorithm}
