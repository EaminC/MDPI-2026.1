...
\Author{Yiming Cheng $^{1}$, Hao Feng $^{2}$, Yitong Ma $^{3}$, Qi Yang $^{1}$ and Yi Yang $^{2,}$*}

%\longauthorlist{yes}

% MDPI internal command: Authors, for metadata in PDF
\AuthorNames{Yiming Cheng, Hao Feng, Yitong Ma, Qi Yang and Yi Yang}

% Affiliations / Addresses (Add [1] after \address if there is only one affiliation.)
\address{%
$^{1}$ \quad University of Chicago, Chicago, IL, USA; eaminchan@uchicago.edu (Y.C.); yangqi@uchicago.edu (Q.Y.)\\
$^{2}$ \quad Tsinghua University, Beijing, China; yangyy@tsinghua.edu.cn (Y.Y.); fh20@mails.tsinghua.edu.cn (H.F.)\\
...
\input{chapters/llm_hybrid_design}
