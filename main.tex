...
\Author{Yiming Cheng $^{1,}$*, Hao Feng $^{2}$, Yitong Ma $^{3}$, Qi Yang $^{1}$, Zhang Yudong $^{2}$, Yi Yang $^{2,}$* and Zhu Han $^{4,}$*}

%\longauthorlist{yes}

% MDPI internal command: Authors, for metadata in PDF
\AuthorNames{Yiming Cheng, Hao Feng, Yitong Ma, Qi Yang, Zhang Yudong, Yi Yang and Zhu Han}
